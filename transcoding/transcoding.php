...
class HyperPWATranscoding
{
	...
	private function init( $home_url, $data )
	{
	...
	private function transcode_html( $page )
	{
		// Service Workers
	...
	private function transcode_head( $page )
	{
	...
	public function transcode( $page, $home_url, $data )
	{
		$this->init( $home_url, $data );

		$page = $this->transcode_html( $page );
		$page = $this->transcode_head( $page );
